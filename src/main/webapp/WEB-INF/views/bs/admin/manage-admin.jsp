          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">登陆次数</span></th>
                <th><span class="glyphicon glyphicon-lock"></span> <span class="visible-lg">状态</span></th>
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td wdith="20%">密码:</td>
                <td width="80%"><input type="text" value="" class="form-control" name="password" maxlength="13" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">确认密码:</td>
                <td width="80%"><input type="password" class="form-control" name="affirmPassword" maxlength="18" autocomplete="off" /></td>
              </tr>
            </tbody>
            <tfoot>
              <tr></tr>

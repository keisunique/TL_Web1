...
<!--[if gte IE 9]>
<script src="/statics/bspage/js/jquery-1.11.1.min.js"></script>
<script src="/statics/bspage/js/html5shiv.min.js"></script>
...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li class="active"><a href="item.jsp">文章</a></li>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="/statics/bspage/images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="/statics/bspage/images/baoman/baoman_01.gif" alt="深思熟虑" />
...
<script src="/statics/bspage/js/bootstrap.min.js"></script>
<script src="/statics/bspage/js/admin-scripts.js"></script>
<script src="/statics/bspage/lib/ueditor/ueditor.config.js"></script>
<script src="/statics/bspage/lib/ueditor/ueditor.all.min.js"> </script>
<script src="/statics/bspage/lib/ueditor/lang/zh-cn/zh-cn.js"></script>
